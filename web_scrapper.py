...
DATASETS_PATH = r"/Users/premsemitha/Desktop/llm/datasets"
...
URLS = {
    ...
    "Clindamycin Hydrochloride Capsules, USP":"https://www.microlabsusa.com/products/cromolyn-sodium-inhalation-solution-usp/",
    ...
    "Glimepiride Tablets, USP ":"https://www.microlabsusa.com/our-products/glimepiride-tablets-usp",    "Ketorolac Tromethamine Ophthalmic Solution ":"",
    ...
    "Rufinamide Tablets, USP": "https://www.microlabsusa.com/products/rufinamide-tablets-usp/",    "Tafluprost Ophthalmic Solution ":"https://www.microlabsusa.com/products/tafluprost-opthalmic-solution/",
...
def setup_prescribing_info_urls(urls_map):
    ...
    for key, value in urls_map.items():
        # Print the product name before processing its URL
        print(f"Searching URL for product: {key}")
...
if __name__ == '__main__':
    ...
    for k, v in modified_urls.items():
        ...
        # Print a message indicating completion of processing for the key
        print(f"Processed: {k}")
